...
export default function AirportBox({airportsInitialData}: AirportBoxProps) {
  ...
  const [showAirportsEditModal, setShowAirportsEditModal] =
    useState<boolean>(false); // Controla a visibilidade do modal de edição
  const [airportToEdit, setAirportToEdit] = useState<AirportType>({
    id: 0,
    airportCode: "",
    city: "",
  }); // Armazena o aeroporto em edição
  ...
  return (
    <div className="mt-10 flex items-center justify-center">
      ...
      <AirportsInfo
        ...
        onClose={onCloseAirportsInfoModal}
        isLoading={loadingAirportsInfoModal}
        airports={airports}
        airportToEdit={airportToEdit}
        setAirportToEdit={setAirportToEdit}
        isOpenEditModal={showAirportsEditModal}
        setIsOpenEditModal={setShowAirportsEditModal}
        onCloseEditModal={onCloseAirportsEditModal}
        isLoadingEditModal={loadingAirportsEditModal}
