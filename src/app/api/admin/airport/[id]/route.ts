...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        if (!airportInfo.city === undefined || airportInfo.airportCode === undefined) {
            return NextResponse.json(
        ...
        const airportEditInfo : AirportType = {id:airportIdNumber, city:airportInfo.city,airportCode:airportInfo.airportCode}
